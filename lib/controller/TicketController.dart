...
class TicketController extends GetxController with StateMixin<dynamic> {
  ...
  Future<List<TicketChat>?> getChat({
    ...
    final parsedJson = await apiProvider.fetch(Variable.LINK_GET_TICKETS,
...
// print(parsedJson);
  ...
  Future<dynamic> getTickets({
    ...
    if (parsedJson == null) {
      ...
      change(GetStatus.success(tickets));
      return parsedJson;
    }
  }
  ...
  Future<TicketChat?> find(Map<String, dynamic> params) async {
    String link = Variable.LINK_GET_TICKETS;
  ...
  Future sendMessage({
    ...
    final res = await apiProvider.fetch(Variable.LINK_CREATE_TICKET_CHAT,
        method: 'post',
        ACCESS_TOKEN: userController.ACCESS_TOKEN,
        param: {
          'subject': subject,
  ...
  Future edit({required Map<String, String?> param}) async {
    final res = await apiProvider.fetch(Variable.LINK_UPDATE_TICKET,
        method: 'post',
        ACCESS_TOKEN: userController.ACCESS_TOKEN,
        param: param);
  ...
  Future create({required String subject, required String message}) async {
    var parsedJson = await apiProvider.fetch(Variable.LINK_CREATE_TICKET,
            method: 'post',
            ACCESS_TOKEN: userController.ACCESS_TOKEN,
            param: {
              'subject': subject,
