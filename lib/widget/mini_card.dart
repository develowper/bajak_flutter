            ...
            child: Card(
              ...
              child: ListView(
                ...
                children: [
                  Container(
                    padding:
                        titlePadding ?? EdgeInsets.all(style.cardMargin / 2),
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.vertical(
                          top: Radius.circular(style.cardBorderRadius / 2)),
                      color: colors[50],
                    ),
                    child: Text(
                      "${title}",
                  ...
                  if (loading != null)
                    Obx(() => Padding(
                          padding: EdgeInsets.all(style.cardMargin).copyWith(
                              top: style.cardMargin / 4,
